    ...
    public class Program
    {
        ...
        public static async Task<int> Main(string[] args)
        {
            return await SynthesisPipeline.Instance
                .SetTypicalOpen(GameRelease.SkyrimSE, "LeveledEncounterZones.esp")
        ...
        public static void RunPatch(IPatcherState<ISkyrimMod, ISkyrimModGetter> state)
        {
            foreach (var ez in state.LoadOrder.PriorityOrder.WinningOverrides<IEncounterZoneGetter>())
            {
                ...
                sbyte newMin = (sbyte)((double)ez.MinLevel * settings.MinLevelScaleFactor);
                sbyte newMax = (sbyte)((double)ez.MinLevel * settings.MaxLevelScaleFactor);
                if ((ez.Flags.HasFlag(EncounterZone.Flag.DisableCombatBoundary) == settings.DisableCombatBoundary) &&
